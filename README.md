...
# How to get started
  1) First, install the script following any one of these   
      * [Windows without installing python](https://github.com/smuft1707/YouTube-Viewer#binary-release)    
      * [Windows from source code](https://github.com/smuft1707/YouTube-Viewer#installation)    
      * [Linux / Mac from source code](https://github.com/smuft1707/YouTube-Viewer#linux--mac)
   2) Then put your video links in the [urls.txt](https://github.com/smuft1707/YouTube-Viewer#urls) file
   3) To search for your video on YouTube and then play it, put the search keywords and video title in the [search.txt](https://github.com/smuft1707/YouTube-Viewer#search) file
   4) Get your [proxy](https://github.com/smuft1707/YouTube-Viewer#proxies) list
...
# Fast VPS with Unlimited Traffic
  *[PetroSky](https://petrosky.io/) is one of the various CloudHosting services with the fastest and most convenient cloud technology. Their servers are powered by the latest **AMD RYZEN/EPYC CPUs** with High-Performance **NVMe SSD Hard Drives** that will let your application run faster than ever. You can get 2 vCPU with 4 GB ECC RAM for as low as 11.99€/month which will work very well for YouTube-Viewer script for 2 threads. Visit [PetroSky](https://petrosky.io/) to get the fastest VPS with unlimited traffic at the lowest price. Use this code `mshawon25` to get **25% discount**  on your purchase*

# Windows
* ## Binary Release

  For windows you can download binary releases from **[Binary releases](https://github.com/smuft1707/YouTube-Viewer/releases)**. Download this file named `YouTube-Viewer_win_x.x.x.zip`, unzip it and run the `youtube_viewer.exe`. Or you can install it from source. To do so keep reading. 
...
* ## Installation
  ...
  ```
  git clone https://github.com/smuft1707/YouTube-Viewer.git --depth 10
  ```
  ```
  cd YouTube-Viewer
  ```
...
* ## Usage
  ...
  * Use both [urls.txt](https://github.com/smuft1707/YouTube-Viewer#urls) and [search.txt](https://github.com/smuft1707/YouTube-Viewer#search)
  * And use as many [urls](https://github.com/smuft1707/YouTube-Viewer#urls) and [keyword::::title](https://github.com/smuft1707/YouTube-Viewer#search) as you can. Don't use just one video.
